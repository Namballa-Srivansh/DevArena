...
export default function Navbar() {
  ...
  const links = [
    ...
    { href: "/arena", label: "Arena Lobby", icon: Swords },
    { href: "/submissions", label: "Audit Trail", icon: Trophy },
    { href: "/admin/create-challenge", label: "Forge Challenge", icon: PlusCircle },
  ];
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-zinc-200 bg-white/80 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
              ...
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : "text-zinc-655 hover:text-zinc-900 hover:bg-zinc-100"
                )}
              >
        ...
        {/* Coder Tag (Right Side) */}
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 rounded-full border border-zinc-200 bg-zinc-100 px-3 py-1 text-xs text-zinc-600">
